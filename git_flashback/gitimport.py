# This is a slightly modified version of `gitimport`
# Credit: Matthias Bartelmeß https://github.com/fourplusone/gitimport (MIT license)
...
class GitImporter(PathEntryFinder):
    def __init__(self, repo_path: str):
        ...
        try:
            ...
            while isinstance(self.commit, pygit2.Tag):
                self.commit = self.repo.get(self.commit.target)
    ...
    def _get_tree_entry(self, key):
        return self.commit.tree[os.path.join(self.in_repo_path, key)]  # type: ignore
...
class GitLoader(Loader):
    ...
    def exec_module(self, module):
        if self.commit_sha is not None:
            module.__git_commit__ = self.commit_sha  # type: ignore
